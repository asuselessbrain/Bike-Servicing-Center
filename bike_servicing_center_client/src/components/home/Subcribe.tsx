...
const Subscribe = () => {
    return (
        <div className="relative h-72 my-20">
            ...
            <div className="h-72 w-3/5 bg-cover bg-center bg-no-repeat absolute right-0 -translate-y-1/2 top-1/2 clipRight" style={{
            ...
            <div className="relative z-20 max-w-[1440px] mx-auto flex items-center justify-between h-full text-white">
                <div>
                    <h2 className="text-2xl md:text-4xl lg:text-5xl italic">Subscribe For Newsletter</h2>
                ...
                <div>
                    <p className="text-gray-200 text-[20px]">We offer you</p>

                    <h3 className="text-2xl md:text-4xl lg:text-4xl font-semibold mt-4 italic">The Best Auto Repair Service</h3>
