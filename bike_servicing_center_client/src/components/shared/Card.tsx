    ...
    return (
        <div className="group rounded-xl overflow-hidden border-2">
            <div className="w-full h-64 relative overflow-hidden">
                ...
                <div className="absolute h-10 w-10 z-20 top-2 group-hover:right-2 bg-primary rounded-full flex items-center justify-center text-white font-semibold text-sm -right-full transition-all duration-500 opacity-0 group-hover:opacity-100">
